...
const quizData = {
  ...
  social: [
    ...
    {
      question:
        "The Renaissance was a period of great cultural change and artistic development that began in which country?",
...
const Quiz: React.FC = () => {
  ...
  const getCelebrationMessage = () => {
    if (
      score >=
      ((selectedSubject && quizData[selectedSubject].length) || 0) * 0.7
    ) {
                ...
                >
                  {subjectMeta.map((sub, i) => (
                    <motion.div
                      ...
                      onClick={() =>
                        handleSubjectSelection(sub.key as keyof typeof quizData)
                      }
                    >
                      <span style={{ fontSize: 33, marginBottom: 6 }}>
                        {sub.icon}
                      </span>
              ...
              >
                ...
                <Box sx={{ mb: 1.1 }}>
                  ...
                  >
                    ...
                    >
                      {
                        subjectMeta.find((s) => s.key === selectedSubject)
                          ?.label
                      }
                    </Typography>
                  </Box>
                  ...
                  >
                    <Typography variant="subtitle1" color="#b7b2c0">
                      Question {currentQuestionIndex + 1}
                    </Typography>
                    <Typography variant="subtitle2" color="#9891a9">
                      Score: <b>{score}</b>
                    </Typography>
                  </Box>
                  <LinearProgress
                ...
                >
                  {quizData[selectedSubject][currentQuestionIndex].options.map(
                    (option, idx) => {
                      const isCorrect =
                        option ===
                        quizData[selectedSubject][currentQuestionIndex].answer;
                      const isSelected = option === selectedAnswer;
                      let btnColor: "contained" | "outlined" | "text" =
                        "outlined";
                          ...
                          <PmsButton
                            ...
                            style={{
                              ...
                              ...(showFeedback && isSelected && isCorrect
                                ? {
                                    background:
                                      "linear-gradient(90deg,#81fa85,#b5f7da 85%)",
                                    color: "#185c19",
                                  }
                                : {}),
                              ...(showFeedback && isSelected && !isCorrect
                                ? {
                                    background:
                                      "linear-gradient(90deg,#fc9292,#fed7b8 85%)",
                                    color: "#a20e14",
                                  }
                                : {}),
                            }}
